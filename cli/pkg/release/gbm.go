...
import (
	...
	"github.com/jhnstn/release-toolkit-gutenberg-mobile/cli/pkg/shell"
	"github.com/jhnstn/release-toolkit-gutenberg-mobile/cli/pkg/utils"

	"github.com/jhnstn/release-toolkit-gutenberg-mobile/cli/pkg/render"
	"github.com/jhnstn/release-toolkit-gutenberg-mobile/cli/pkg/repo"
)
...
func CreateGbmPR(build Build) (gh.PullRequest, error) {
	...
	if (exists != gh.Branch{}) {
		...
		console.Info("Cloning Gutenberg Mobile (via https) to %s", dir)
